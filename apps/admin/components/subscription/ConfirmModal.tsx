    ...
    <Modal>
      <div className="flex flex-col items-center px-4 py-4 md:py-0 gap-4 md:gap-6">
        ...
        <div className="text-md font-thin text-center hidden md:block">
          The new price will only affect new users, not existing ones who have
          already purchased a plan on Track My Care.
        </div>
        <div className="text-md text-center md:hidden font-thin">
          All the records and exam history will be deleted for this family
          member’s profile
        </div>
        <div className="flex flex-row w-full gap-2 md:w-[60%] mb-4 md:mb-10">
          ...
          <Button
            ...
            className="w-1/2 text-sm h-10 bg-secondary text-primary hover:bg-secondary border-primary border-[1px]">
            Cancel
          </Button>
        </div>
      </div>
