...
function PricingStartNow() {
    return (
        <div className='bg-primary text-secondary px-6 py-10 md:px-16 flex flex-col gap-2 md:flex-row  relative'>
            <div className='absolute right-0 z-10'><Image src={Ellipse} alt="logo" width={200} height={200} /></div>
            <div className='absolute left-0 bottom-0 z-10'><Image src={Ellipse1} alt="logo" width={210} height={210} /></div>
            <div className='flex flex-col gap-2 md:w-[60%] md:py-40'>
