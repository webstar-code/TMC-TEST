        ...
        <div className='bg-primary text-secondary px-6 py-10 md:px-16 flex flex-col gap-2 md:flex-row md:py-20'>
            <div className='flex flex-col gap-2 md:w-[60%]'>
                ...
                <div className='mt-6 md:hidden'>
                    <Image src="/StartNow.svg" alt='' className='mx-auto' width={200} height={200} />
                </div>
                <div className='text-2xl font-bold mt-6 md:mt-14'>TrackMyCare Features:</div>
                <div className='flex flex-col gap-8 mt-6'>
                    <div className='flex flex-row gap-4'>
                        <Image src='/white_tick.svg' alt='' height={20} width={20} />
                ...
                <div className='flex justify-center md:justify-start mt-6'>
                    <Button text="Start Tracking" className="bg-secondary text-primary h-10 w-[50%]">Start Tracking</Button>
                </div>
            </div>
            <div className='flex items-center justify-center w-[40%]'>
                <Image src="/StartNow.svg" alt='' className='mx-auto hidden md:block' width={300} height={200} />
            </div>
        </div>
    )
}
