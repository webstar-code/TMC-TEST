...
function FAQs() {
  return (
    <div className="px-6 md:px-16 mt-10 md:mt-20">
      <div className="w-full font-bold text-xl md:text-3xl">
      ...
      <div className="md:mt-10 mt-6">
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            <AccordionTrigger>
              Why should I enroll in TrackMyCare?
            </AccordionTrigger>
            <AccordionContent>
              <div className="font-thin flex flex-col gap-1 text-base">
                Our medical cloud storage platform offers you the benefit of
                ...
                care, reduces duplication of tests, and ultimately empowers you
                to take more proactive control of your health while streamlining
      ...
      <div>
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <div className="font-thin flex flex-col gap-1 text-base">
                Rest assured, your health information and medical records are of
                utmost importance in a secure and private medical cloud
                platform. The TrackMyCare platform employs robust encryption,
                multi-layered security protocols, and stringent privacy measures
                to safeguard your data. Access is strictly controlled, with only
                authorized individuals having the ability to view and manage
                records. Regular security audits and compliance with healthcare
                data protection regulations ensure the highest standards of data
                integrity. Your privacy is a top priority, and you can trust
                that your medical information is in safe hands, allowing you to
                focus on your health with confidence.
              </div>
            </AccordionContent>
          </AccordionItem>
        </Accordion>
