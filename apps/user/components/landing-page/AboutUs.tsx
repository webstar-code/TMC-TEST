...
function AboutUs() {
    return (
        <div className='px-6 py-10 flex flex-col gap-6 md:px-16'>
            ...
            <div className='md:flex-row md:flex md:mt-10 md:gap-10'>
                <div className='shadow rounded-xl px-2 py-4 flex flex-col gap-4'>
                    <div className='flex flex-row items-center gap-4'>
                        <div>
                            <Image src='/WhoAreWe.svg' alt='' width={50} height={50} />
                        </div>
                ...
                <div className='shadow rounded-xl px-2 py-4 flex flex-col gap-4'>
                    <div className='flex flex-row items-center gap-4'>
                        <Image src='/WhatWeDo.svg' alt='' width={50} height={50} />
            ...
            <div className='flex flex-row overflow-x-scroll md:overflow-auto gap-8 mt-10 md:mt-20'>
                <Image src='/BBC.svg' alt='' className='md:hidden' width={70} height={70} />
                <Image src='/Traveler.svg' alt='' className='md:hidden' width={70} height={70} />
                <Image src='/IndiaToday.svg' alt='' className='md:hidden' width={70} height={70} />
                <Image src='/Outlook.svg' alt='' className='md:hidden' width={70} height={70} />
                <Image src='/Express.svg' alt='' className='md:hidden' width={70} height={70} />
                <Image src='/Welle.svg' alt='' className='md:hidden' width={70} height={70} />
                <Image src='/mint.svg' alt='' className='md:hidden' width={70} height={70} />
                <Image src='/TimesOfIndia.svg' alt='' className='md:hidden' width={70} height={70} />
                <Image src='/BBC.svg' alt='' className='md:block hidden' width={150} height={100} />
                <Image src='/Traveler.svg' alt='' className='md:block hidden' width={150} height={100} />
                <Image src='/IndiaToday.svg' alt='' className='md:block hidden' width={150} height={100} />
                <Image src='/Outlook.svg' alt='' className='md:block hidden' width={150} height={100} />
                <Image src='/Express.svg' alt='' className='md:block hidden' width={150} height={100} />
                <Image src='/Welle.svg' alt='' className='md:block hidden' width={150} height={100} />
                <Image src='/mint.svg' alt='' className='md:block hidden' width={150} height={100} />
                <Image src='/TimesOfIndia.svg' alt='' className='md:block hidden' width={150} height={100} />
            </div>
        </div>
    )
}
