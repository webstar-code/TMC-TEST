    ...
    return (
        <div className='px-6 flex flex-col gap-12 py-20 md:px-16'>
            <div className='px-2 flex flex-col gap-3 md:gap-10'>
                <div className='w-full text-center font-bold text-xl md:text-4xl'>Designed for Utility</div>
            ...
            <div className='flex flex-col md:flex-row md:w-full md:justify-between md:items-center gap-10'>
                <div className='shadow rounded-xl py-10 px-4 flex flex-col gap-3 md:w-1/2'>
                ...
                <div className='md:w-1/2'>
                    <Image src='/CloudInfra.svg' alt='' className='mx-auto' width={380} height={100} />
                </div>
            </div>
            <div className='flex flex-col md:flex-row md:w-full md:justify-between md:items-center md:gap-10 gap-10'>
                <div className='flex flex-col gap-3 shadow rounded-xl py-6 px-4 md:w-1/2 md:order-2 md:gap-8'>
                ...
                <div className='md:order-1 md:w-1/2'>
                    <Image src='/CheckList.svg' alt='' className='mx-auto' width={320} height={100} />
                </div>
            </div>
        </div>
    )
