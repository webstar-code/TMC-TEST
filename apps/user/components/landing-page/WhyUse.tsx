        ...
        <div className='w-full px-6 py-10 md:py-24'>
            <div className='w-full'>
                <div className='w-full justify-center items-center flex flex-col gap-2 md:gap-6 md:px-16'>
                    ...
                    <div className='font-bold text-2xl md:text-4xl'>Easy, Simple, Affordable</div>
                    <div className='font-light text-center text:sm md:text-lg md:w-[40%] mt-2'>A solution designed to give you easy access to all of your healthcare data and documents.</div>
                </div>
