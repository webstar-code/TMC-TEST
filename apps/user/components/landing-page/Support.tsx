                ...
                <div className="w-full md:w-1/2 h-full flex flex-col py-6">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-sm text-[#6B6B6B]">Mudrochova 7480/15, Bratislava, 831 06, Slovakia</p>
                        </div>
                        <div className="flex flex-col gap-2">
                            <h1 className="text-base font-semibold uppercase">asdfsa</h1>
                            <p className="text-sm text-[#6B6B6B]">Mon-Fri: 08:30am - 06:00pm</p>
                            <p className="text-sm text-[#6B6B6B]">Saturday: 09:00am - 01:00pm</p>
                        </div>
                        <div className="flex flex-col gap-2">
