  ...
  const cardContent = [
    {
      ...
      description:
        "TrackMyCare can be integrated with your health information system/electronic medical record and can retrieve selected patient health information for patient use.",
      imageUrl: YourHealthCould,
    },
    {
      title: "Shareability",
      description:
        "Our easy to use platform allows patients to securely share their medical records with other healthcare providers.",
      imageUrl: SecureStorage,
    },
    {
      title: "Data Security",
      description:
        "All of our patient records are secured and HIPAA compliant. Our privacy policies ensure the security and privacy of patient medical records.",
      ...
      <div className="w-full">
        <div className="w-full justify-center items-center flex flex-col gap-2 md:gap-6 md:px-16">
          <div className="font-bold md:text-xl">
            WHY PARTNER WITH TRACK MY CARE?
          </div>
          <div className="font-bold text-2xl md:text-4xl">
            Improved Patient Experience
          </div>
          <div className="font-light text-center text:sm md:text-lg md:w-[40%] mt-2">
            In partnering with TrackMyCare your patients will have convenient
            secure access to their medical records providing for a more complete
            patient experience.
          </div>
        </div>
