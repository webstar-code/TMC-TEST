...
const toJson = (data: any) => {
  ...
  changeValues(d, "currentPeriodStart", (val: any) =>
    convertToFirebaseTimestamp(val)
  );
  changeValues(d, "currentPeriodEnd", (val: any) =>
    convertToFirebaseTimestamp(val)
  );
...
const fromJson = (data: any) => {
  ...
  changeValues(d, "currentPeriodStart", (val: any) => convertToDate(val));
  changeValues(d, "currentPeriodEnd", (val: any) => convertToDate(val));
  return d;
};
